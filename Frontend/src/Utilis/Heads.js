...
const Heads = () => {
  return (
    <Head>
      ...
      <meta property="twitter:url" content="https://www.thebrchub.tech/" />
    ...
    <meta property="og:url" content="https://thebrchub.tech" />
      ...
      <meta property="og:image" content="https://thebrchub.tech/og-image.png" /> {/* Replace with actual OG image URL if available */}
...
{`
{
  ...
  "logo": "https://www.thebrchub.tech/og-image.png",
